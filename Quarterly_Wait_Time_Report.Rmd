...
# Primary Care = "Internal Medicine"
  ...
  vol_slide_takeaways <- block_list(fpar(ftext(paste0("Total volume from ",reporting_start," to ",reporting_end," was ",dept_monthly_vol_takeaway(i)[1],
                                    ...
                                    fpar(ftext(paste0("This is ",dept_monthly_vol_takeaway(i)[4]," change from same months last year (",reporting_prior[1],
                                                      " to ",reporting_prior[length(reporting_prior)],")"),
                                               prop = fp_text(font.family = 'Calibri',font.size=14))),
  ...
  print(ppt_temp, target=paste0("Wait Time Report-",reporting_current[1],"_",reporting_current[length(reporting_current)],".pptx"))
