...
vol_zip_code <- scheduling_data_raw %>%
  filter(Appt.Status == "Arrived") %>%
  filter(Appt.DateYear <= max(scheduling_data_raw$Appt.Made.DateYear))
...
dept_heat_map_function <- function(department){
  ...
  # Create a color palette with handmade bins.
      ...
      webshot("/nfs/data/Applications/Ambulatory/Quarterly_Data/vol_heat_map.html", 
              file = "file:///nfs/data/Applications/Ambulatory/Quarterly_Data/vol_heat_map.png", cliprect = "viewport")
              #  c(0, 200, 1000, 1400)
