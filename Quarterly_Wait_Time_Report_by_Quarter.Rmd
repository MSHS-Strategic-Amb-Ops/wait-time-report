...
# Set variables for report
reporting_specialties <- c("Urology","Gastroenterology","Cardiology","Internal Medicine",
                          "ENT-Otolaryngology","Neurology","Endocrinology","Orthopedics")

reporting_start <- "2022-10-01"
reporting_end <- "2022-12-31"

quarter_start <- "2021-01-01"
quarter_end <- "2023-01-01"
...
monthly_vol <- scheduling_data_raw %>%
  ...
  filter(Appt.DateYear <= as.Date(reporting_end)) %>%
...
arrived_data_source <- paste0("Data Source: Epic EMR - Arrived Visits from ", reporting_start, " to ", reporting_end,
                              "; includes ", paste(inc_sites, collapse = ", "))
scheduled_data_source <- paste0("Data Source: Epic EMR - Scheduled Visits from ", reporting_start, " to ", reporting_end,
                                "; includes ", paste(inc_sites, collapse = ", "))
...
# Primary Care = "Internal Medicine"
  ...
  print(ppt_temp, target=paste0(reporting_YearQtr," Wait Time_UPDATED.pptx"))
